...
export default function Topbar({ onMenuClick }) {
  ...
  const handleNotifClick = async (notif) => {
    ...
    // If this notification points to a specific resource (hosting/domain),
    // verify it still exists before navigating — if 404, auto-delete the stale alert
    if (notif.entityId && notif.entityType && route !== '/dashboard') {
      try {
