...
import {
  ...
  Search, KeyRound, History, Tag, Gift, Megaphone, Mail
} from 'lucide-react'
...
const ADMIN_NAV = {
  ...
  finance: [
    ...
    { to: '/reports/spend-forecast', icon: BarChart2, label: 'Spend Forecast' },
  ],
  system: [
  ...
  tools: [
    ...
    { to: '/referral', icon: Gift, label: 'Referral', roles: ['admin'] },
  ],
  settings: [
...
const SUPER_ADMIN_NAV = {
  platform: [
    ...
    { to: '/super-admin/coupons', icon: Tag, label: 'Coupons' },
    { to: '/super-admin/referrals', icon: Gift, label: 'Referrals' },
      ...
      <nav className="flex-1 px-3 py-2 overflow-y-auto space-y-0.5">
        {isSuperAdmin ? (
          ...
          <>
            ...
            <SectionLabel label="Communications" theme={theme} />
            {ADMIN_NAV.communications.map(i => (
              <NavItem key={i.to} item={i} theme={theme} onClick={onClose} />
            ))}
